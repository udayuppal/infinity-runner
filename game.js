window.onload = function () {
    ...
    const ROCK_SIZE = 180;
    const ROCK_WIDTH = 0.53 * ROCK_SIZE;
    ...
    function rock() {
        ...
        this.x = CANVAS.width + this.size/2 - 10;
        this.x_vel = obstacle_speed;
        this.draw = function () {
            var sprite = new Image();
            sprite.src = "sprites/Rock.png"
            CONTEXT.drawImage(sprite, this.x - this.size/2 + 10, this.y - this.size/2 - 50, this.size, this.size);            
        }
    }
